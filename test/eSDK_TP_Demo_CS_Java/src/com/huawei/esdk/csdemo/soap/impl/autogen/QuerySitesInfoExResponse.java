 ...
 *         &lt;element name="sites" type="{http://smc.huawei.com/}TerminalInfoEx" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "querySitesInfoExResponse")
public class QuerySitesInfoExResponse {

    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "int")
    protected Integer resultCode;
    protected List<TerminalInfoEx> sites;
     ...
     * 
     */
    public List<TerminalInfoEx> getSites() {
        if (sites == null) {
            sites = new ArrayList<TerminalInfoEx>();
        }
        return this.sites;
    }
