package com.huawei.esdk.csdemo.soap.impl.utils;
...
import com.huawei.esdk.csdemo.soap.impl.interceptor.MsgInInterceptor;
import com.huawei.esdk.csdemo.soap.impl.interceptor.MsgOutInterceptor;
...
public abstract class ClientProvider
{
    ...
    public static synchronized Object getClient(Class clz)
    {
        ...
        {
            serviceUrl = PropertiesUtils.getValue("tpCommon.service.url");
        }
        else if (clz.getName().equals(TPProfessionalConfMgr.class.getName()))
        {
            serviceUrl = PropertiesUtils.getValue("confMgr.service.url");
        }
    ...
    private static Object configureSSL(Object obj, Class clz)
    {
        ...
        try
        {
            ...
            String storePassword =
                new String(
                    AES128Utils.decode(Base64Utils.getFromBASE64(PropertiesUtils.getValue("ssl.keystore.password"))), "UTF-8");
            is =
